...
namespace Renderer
{
    ...
    Triangle::Triangle(glm::vec3 v1, glm::vec3 v2, glm::vec3 v3)
    {
        ...
        // v1
        current.position = v1;
        current.texCoords = glm::vec2(0.5, 1.0);
        vertices.push_back(current);
        indices.push_back(0);
        // v2
        current.position = v2;
        current.texCoords = glm::vec2(0.0, 0.0);
        vertices.push_back(current);
        indices.push_back(1);
        // v3
        current.position = v3;
        current.texCoords = glm::vec2(1.0, 0.0);
        vertices.push_back(current);
        indices.push_back(2);
    ...
    Cube::Cube(float width, float height, float depth)
    {
        ...
        std::vector<Vertex> vertices =
            {
                Vertex(-halfWidth, -halfHeight, -halfDepth, 0.f, 0.f, -1.f, 0.f, 1.f, 1.0, 0.0, 0.0),
                Vertex(-halfWidth, +halfHeight, -halfDepth, 0.f, 0.f, -1.f, 0.f, 0.f, 0.0, 0.0, 1.0),
                Vertex(+halfWidth, +halfHeight, -halfDepth, 0.f, 0.f, -1.f, 1.f, 0.f, 0.0, 1.0, 0.0),
                Vertex(+halfWidth, -halfHeight, -halfDepth, 0.f, 0.f, -1.f, 1.f, 1.f, 1.0, 0.0, 1.0),

                Vertex(-halfWidth, -halfHeight, +halfDepth, -1.f, 0.f, 0.f, 0.f, 1.f, 1.0, 0.0, 0.0),
                Vertex(-halfWidth, +halfHeight, +halfDepth, -1.f, 0.f, 0.f, 0.f, 0.f, 0.0, 0.0, 1.0),
                Vertex(-halfWidth, +halfHeight, -halfDepth, -1.f, 0.f, 0.f, 1.f, 0.f, 0.0, 1.0, 1.0),
                Vertex(-halfWidth, -halfHeight, -halfDepth, -1.f, 0.f, 0.f, 1.f, 1.f, 0.0, 1.0, 0.0),

                Vertex(+halfWidth, -halfHeight, +halfDepth, 0.f, 0.f, 1.f, 0.f, 1.f, 1.0, 0.0, 0.0),
                Vertex(+halfWidth, +halfHeight, +halfDepth, 0.f, 0.f, 1.f, 0.f, 0.f, 0.0, 1.0, 0.0),
                Vertex(-halfWidth, +halfHeight, +halfDepth, 0.f, 0.f, 1.f, 1.f, 0.f, 0.0, 0.0, 1.0),
                Vertex(-halfWidth, -halfHeight, +halfDepth, 0.f, 0.f, 1.f, 1.f, 1.f, 1.0, 1.0, 0.0),

                Vertex(+halfWidth, -halfHeight, -halfDepth, 1.f, 0.f, 0.f, 0.f, 1.f, 1.0, 0.0, 0.0),
                Vertex(+halfWidth, +halfHeight, -halfDepth, 1.f, 0.f, 0.f, 0.f, 0.f, 1.0, 0.0, 0.0),
                Vertex(+halfWidth, +halfHeight, +halfDepth, 1.f, 0.f, 0.f, 1.f, 0.f, 1.0, 0.0, 0.0),
                Vertex(+halfWidth, -halfHeight, +halfDepth, 1.f, 0.f, 0.f, 1.f, 1.f, 1.0, 0.0, 0.0),

                Vertex(-halfWidth, +halfHeight, -halfDepth, 0.f, 1.f, 0.f, 0.f, 1.f, 1.0, 0.0, 0.0),
                Vertex(-halfWidth, +halfHeight, +halfDepth, 0.f, 1.f, 0.f, 0.f, 0.f, 0.0, 0.0, 1.0),
                Vertex(+halfWidth, +halfHeight, +halfDepth, 0.f, 1.f, 0.f, 1.f, 0.f, 1.0, 0.0, 0.0),
                Vertex(+halfWidth, +halfHeight, -halfDepth, 0.f, 1.f, 0.f, 1.f, 1.f, 0.0, 1.0, 1.0),
