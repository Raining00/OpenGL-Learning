...
public:
    ...
    virtual void Init() override
    {
        ...
        m_lightManager->CreatePointLight("PointLight0", glm::vec3(0.0f, 0.5f, 0.f), ambient, diffuse, specular * 100.f, 1.0f, 0.7, 1.8);
        m_lightManager->CreatePointLight("PointLight1", glm::vec3(7.f, 0.5f, 0.f), glm::vec3(0.1f, 0.0f, 0.0f), glm::vec3(0.4f, 0.0f, 0.0f), glm::vec3(0.6f, 0.0f, 0.0f), 1.0f, 0.7, 1.8);
        m_lightManager->CreatePointLight("PointLight2", glm::vec3(-7.f, 0.5f, 0.f), glm::vec3(0.0f, 0.0f, 0.2f), glm::vec3(0.0f, 0.0f, 0.5f), glm::vec3(0.0f, 0.0f, 0.8f), 1.0f, 0.7, 1.8);
