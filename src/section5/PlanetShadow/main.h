...
public:
    ...
    virtual void Init() override
    {
        ...
        unsigned int sunTexture = m_textureManager->loadTexture2D("sunTexture", ASSETS_PATH"/texture/sun.jpg", Renderer::TextureType::DIFFUSE);
...
private:
    glm::vec3 sunLightDir{ glm::vec3(-1.0, 0.017, -0.125) };
